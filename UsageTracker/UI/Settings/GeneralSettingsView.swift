...
/// Settings › General: 2.x General's Startup, Refresh and Updates sections, regrouped
/// as the mockup does. 2.x's popover shortcut is gone (owner's decision, 2026-09-26).
